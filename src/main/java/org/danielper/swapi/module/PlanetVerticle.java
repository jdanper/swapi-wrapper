...
public class PlanetVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        bus.consumer(MessageTypes.GET_ALL_PLANETS, this::getAllPlanets);
        bus.consumer(MessageTypes.NEW_PLANET, this::newPlanet);

        super.start(startFuture);
    }

    private void getAllPlanets(Message<JsonObject> msg) {
        bus.send(MessageTypes.QUERY_ALL_PLANETS, null, res -> {
    ...
    private void newPlanet(Message<JsonObject> msg){
        ...
        bus.send(MessageTypes.INSERT_PLANET, msg.body(), res -> {
           if(res.failed()){
